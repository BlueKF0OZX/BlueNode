...
const softRadioLifecycle = fs.readFileSync(path.join(root, 'install/soft-radio-rx.sh'), 'utf8');
const softRadioTransaction = fs.readFileSync(path.join(root, 'install/soft-radio-transaction.sh'), 'utf8');
