...
and dashboard guide. The tracked-source privacy check passed. The installation
engine and Windows app logic are unchanged from the integration validation below;
